...
Content created by Kat Barrett, Kassandra Lenters, &amp; Erin Morris for [Canada Learning Code](http://canadalearningcode.ca/).
...
Contenu créé par Kat Barrett, Kassandra Lenters, &amp; Erin Morris pour [Canada en programmation](http://canadalearningcode.ca/fr).
